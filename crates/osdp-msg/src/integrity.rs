...
/// CRC16-CCITT taken directly from the OSDP specification
pub(crate) fn calc_crc(msg: &[u8]) -> u16 {
...
/// Pre-built lookup table taken directly from the OSDP specification
